...
extension Category {
    ...
    static let groceires = Category(id: 501, name: "Groceires", icon: .shopping_basket, mainCategoryId: 5)
...
extension Category {
    static let catogories: [Category] = [
        .autoAndTransport,
        .billsAndUtilities,
        .entertainment,
        .feesAndCharges,
    ...
    static let subCateogories: [Category] = [
    ...
    static let all: [Category] = catogories + subCateogories
}
